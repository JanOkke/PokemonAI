...
if __name__ == '__main__':
    ...
    class MainFrame(gui.CalculatorFrame):
        ...
        def calculate( self, event ):
            ...
            print(left_mon.hp, left_mon.attack, left_mon.defense, left_mon.sp_atk, left_mon.sp_def, left_mon.speed)
            print(right_mon.hp, right_mon.attack, right_mon.defense, right_mon.sp_atk, right_mon.sp_def, right_mon.speed)
